    ...
    <div className="relative min-h-screen bg-white">
      ...
      >
        <main className="pt-24 pb-32">
          {/* ── Breadcrumb ───────────────────────────────────────────────── */}
          <div className="hidden md:flex justify-center mb-10 pt-4">
            <Breadcrumbs
          ...
          {/* MOBILE: px-5, DESKTOP: px-10 md:px-20 — unchanged */}
          <div className="mx-auto w-full max-w-[1100px] px-5 md:px-10 lg:px-20">
            {/* Hero two-col */}
            <section className="mb-16">
              <div className="flex flex-col md:flex-row justify-between gap-6 md:gap-16">
                <FadeIn delay={0.1} className="md:w-[38%] shrink-0">
                  <p className="text-[18px] md:text-[22px] font-bold leading-snug text-center md:text-left">
                ...
                <FadeIn delay={0.2} className="md:w-[55%]">
                  <p className="text-[12px] md:text-[13px] text-gray-300 leading-relaxed text-center md:text-right">
            ...
            <section className="mb-6">
              <div className="flex flex-col md:flex-row justify-between gap-6 md:gap-16">
                <FadeIn delay={0.1} className="md:w-[38%] shrink-0">
                  <h2 className="text-2xl md:text-[26px] font-bold text-center md:text-left">
                    Current Openings
                  </h2>
                </FadeIn>
                <FadeIn delay={0.2} className="md:w-[55%]">
                  {jobs.length === 0 ? (
                    <p className="text-[12px] md:text-[13px] text-gray-300 leading-relaxed text-center md:text-left">
            ...
            <FadeIn delay={0.3} className="mb-24">
              <div className="flex flex-col items-center sm:flex-row sm:items-center justify-between gap-3">
                <p className="text-[12px] text-gray-400 italic text-center sm:text-left">
          ...
          {/* MOBILE: px-5 py-8 with smaller text, DESKTOP: px-[82px] py-[40px] — unchanged */}
          <section className="px-5 md:px-10 max-w-[1320px] mx-auto mb-16">
            <FadeIn>
              <div className="bg-white rounded-[25px] text-center flex flex-col items-center w-full px-6 py-8 gap-4 md:px-[82px] md:py-[40px]">
                <h2
                  className="text-black text-[26px] md:text-[36px] font-bold leading-tight"
                  style={{
                ...
                <p
                  className="text-gray-500 text-[14px] md:text-[16px] italic leading-snug"
                  style={{
                    fontFamily: "var(--font-poppins)",
                    fontWeight: 400,
                    fontStyle: "italic",
          ...
          <FadeIn
            delay={0.1}
            className="px-5 md:px-10 lg:px-20 max-w-[1100px] mx-auto mb-20 text-center"
          >
          ...
          <section className="px-5 md:px-10 lg:px-20 max-w-[1100px] mx-auto mb-24">
            <div className="flex flex-col md:flex-row items-start gap-10">
              {/* decorative career image shown on larger screens only */}
              ...
              <div className="flex flex-col gap-5 w-full md:max-w-[580px] md:ml-auto">
                {perks.map((perk, i) => (
          ...
          {/* ── Testimonials ──────────────────────────────────────────────── */}
          <section className="px-5 md:px-10 lg:px-20 max-w-[1100px] mx-auto mb-28">
            {/* MOBILE: flex-col (stacked), DESKTOP: flex-row — md:flex-row unchanged */}
       ...
       {/* ── Looking Ahead ─────────────────────────────────────────────── */}
<section className="px-5 md:px-10 lg:px-20 max-w-[1100px] mx-auto">
  ...
  <FadeIn delay={0.15} className="text-center mb-8">
    <p className="text-[13px] text-gray-400 max-w-[260px] mx-auto leading-relaxed">
      If you'd like to be part of Incial's future opportunities, send us your resume at:
    </p>
  </FadeIn>

  <FadeIn delay={0.25}>
    {/* MOBILE EXACT DESIGN */}
    <div className="flex flex-col items-center text-center gap-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center gap-2 text-blue-400 text-[13px]"
      >
        ...
        {/* ── Footer ────────────────────────────────────────────────────────── */}
        <div className="px-5 md:px-10 lg:px-20 max-w-[1100px] mx-auto">
          <Footer />
        </div>
      </motion.div>
    </div>
