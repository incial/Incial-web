...
const StatsSlideComponent = ({ id, onInView }: StatsSlideProps) => {
  return (
    <MobileSlide id={id} onInView={onInView}>
      <div className="flex h-full w-full flex-col items-center justify-center bg-black px-6 text-white">
        <h2 className="mb-14 text-[34px] font-light tracking-[-0.02em] text-white">
